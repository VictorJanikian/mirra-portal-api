...
namespace Mirra_Portal_API.Database.Mapper
{
    public class CustomerContentPlatformConfigurationTableRowProfile : Profile
    {
        ...
        {
            CreateMap<CustomerPlatformConfiguration, CustomerContentPlatformConfigurationTableRow>()
            ...
            CreateMap<CustomerContentPlatformConfigurationTableRow, CustomerPlatformConfiguration>();
        }
    }
}
